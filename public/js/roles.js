...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Role_Table_vue__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Role_Table_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Role_Table_vue__);



__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('roles', __WEBPACK_IMPORTED_MODULE_1__components_Role_Table_vue___default.a);

new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app-role',
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_1__components_Role_Table_vue___default.a);
  }
});
...
Component.options.__file = "resources/assets/js/components/Role/Table.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9b568868", Component.options)
  } else {
    hotAPI.reload("data-v-9b568868", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Form_vue__ = __webpack_require__(65);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5f8d3436", Component.options)
  } else {
    hotAPI.reload("data-v-5f8d3436", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		storeRole: function storeRole() {
			var self = this;
			axios.post('/roles', self.role).then(function (data) {
				var res = data.data;
				if (res.result) {
					self.showModal = false;
					self.clearForm();
		...
		editRole: function editRole(id) {
			...
			fetch('roles/' + id).then(function (res) {
				return res.json();
			}).then(function (res) {
				var self = _this;
				self.clearForm();
		...
		updateRole: function updateRole(role_id) {
			var self = this;
			axios.put('/roles/' + role_id, self.role).then(function (data) {
				var res = data.data;
				if (res.result) {
					self.clearForm();
					self.showModal = false;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5f8d3436", module.exports)
  }
}
            ...
            _c(
              ...
              _vm._l(_vm.roles, function(role) {
                return _c("tr", { key: role.id }, [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(role.role_status))]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _c(
                      "button",
                      {
                        ...
                        attrs: { disabled: role.id == 1 },
                        on: {
                          click: function($event) {
                            return _vm.openForm("edit", role.id)
                          }
                        }
                      },
                      [
                    ...
                    _c(
                      "button",
                      {
                        ...
                        attrs: { disabled: role.status == 0 || role.id == 1 },
                        on: {
                          click: function($event) {
                            return _vm.openDeleteModal("delete", role.id)
                          }
                        }
                      },
                      [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9b568868", module.exports)
  }
}
