...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Profile_Info_vue__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Profile_Info_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Profile_Info_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Profile_Security_vue__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Profile_Security_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Profile_Security_vue__);



Vue.component('information', __WEBPACK_IMPORTED_MODULE_0__components_Profile_Info_vue___default.a);
Vue.component('security', __WEBPACK_IMPORTED_MODULE_1__components_Profile_Security_vue___default.a);

new Vue({
  el: '#app-profile',
  components: {
    'information': __WEBPACK_IMPORTED_MODULE_0__components_Profile_Info_vue___default.a,
    'security': __WEBPACK_IMPORTED_MODULE_1__components_Profile_Security_vue___default.a
  }
});
...
Component.options.__file = "resources/assets/js/components/Profile/Info.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-512f792b", Component.options)
  } else {
    hotAPI.reload("data-v-512f792b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Alert_vue__ = __webpack_require__(28);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		fetchData: function fetchData() {
			var self = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/users/' + Laravel.userId).then(function (res) {
				var result = res.data;
		...
		submitForm: function submitForm() {
			var self = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/profile/edit-profile', self.user).then(function (data) {
				var res = data.data;
				if (res.result) {
					self.edit = false;
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "card center-60" },
    [
      _c("div", { staticClass: "card-header" }, [
        _c("h5", [_vm._v("Profile Information")]),
        _vm._v(" "),
        _c("div", { staticClass: "float-right" }, [
          !_vm.edit
            ? _c(
                "button",
                {
                  staticClass: "btn btn-sm-text btn-grey ",
                  on: {
            ...
            ? _c("div", { staticClass: "card-footer " }, [
                _c("div", { staticClass: "float-right" }, [
                  ...
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-sm-text btn-blue",
                      attrs: { type: "submit" }
                    },
                    [_vm._v("Save Changes")]
                  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-512f792b", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/Profile/Security.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6267f83d", Component.options)
  } else {
    hotAPI.reload("data-v-6267f83d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		submitForm: function submitForm() {
			var self = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/profile/change-password', self.passwordData).then(function (data) {
				console.log(data);
				var res = data.data;
				if (res.result) {
                ...
                _c("div", { staticClass: "input-container" }, [
                  _c("div", { staticClass: "input-wrapper" }, [
                    ...
                    _c("input", {
                      ...
                      domProps: { value: _vm.passwordData.password },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.passwordData.password_confirmation,
                          expression: "passwordData.password_confirmation"
                        }
                      ],
                      staticClass: "input-element",
                      attrs: { type: "password", required: "" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6267f83d", module.exports)
  }
}
